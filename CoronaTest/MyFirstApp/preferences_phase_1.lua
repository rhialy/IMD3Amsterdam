...
function scene:create(event)
    ...
    lionButton = display.newImageRect("lion.jpg", pictureSize, pictureSize);
    lionButton.x = centerX - 85;
    lionButton.y = centerY - 150;
    leopardButton = display.newImageRect("lion.jpg", pictureSize, pictureSize);
    leopardButton.x = centerX + 85;
    leopardButton.y = centerY - 150;
    dogButton = display.newImageRect("lion.jpg", pictureSize, pictureSize);
    dogButton.x = centerX - 85;
    dogButton.y = centerY + 80;
    apeButton = display.newImageRect("lion.jpg", pictureSize, pictureSize);
